...
namespace POP3ReverseProxyServer
{
  class Program
  {
            ...
            [Optional(false, "d")] bool debug)
    {
      ...
      Console.WriteLine("Starting POP3 server {0}, debugging {1} ...", RemoteHostPort, Program.cDebuggingOn);
      ...
      try
      {
        ...
        if (POP3ReverseProxyServer.POP3SReverseProxy.Server.Start(lLocalPort, lRemoteHost, lRemotePort, lRedirectTo))
        {
          Console.WriteLine("Press enter to exit");
          Console.ReadLine();
          POP3ReverseProxyServer.POP3SReverseProxy.Server.Stop();
        }
        else
