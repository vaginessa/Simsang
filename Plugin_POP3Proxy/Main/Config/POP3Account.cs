...
{
  public class POP3Account : INotifyPropertyChanged
  {
    ...
    public POP3Account(String pSrcMAC, String pSrcIP, String pDstIP, String pDstPort, String pUsername, String pPassword, String pServer)
    {
      mSrcMAC = pSrcMAC;
      mSrcIP = pSrcIP;
      mDstIP = pDstIP;
