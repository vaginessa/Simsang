...
namespace POP3SReverseProxyServer
{
  class Program
  {
    ...
    /*
     * POP3ReverseProxyServer.exe 80 /rhp:pop3s.google.com; /d
     */
            ...
            [Optional(false, "d")] bool debug)
    {
      ...
      Console.WriteLine("Starting POP3S server with Certificate {0}, debugging {1} ...", RemoteHostPort, Program.cDebuggingOn);
      ...
      try
      {
        ...
        if (POP3SReverseProxyServer.POP3SReverseProxy.Server.Start(lLocalPort, lRemoteHost, lRemotePort, lRedirectTo, lCertificatePath))
        {
          Console.WriteLine("Press enter to exit");
          Console.ReadLine();
          POP3SReverseProxyServer.POP3SReverseProxy.Server.Stop();
        }
        else
