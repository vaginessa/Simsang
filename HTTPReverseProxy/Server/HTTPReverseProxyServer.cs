...
if (Program.cDebuggingOn)
  Console.WriteLine("Remote system {0}/{1}, Redirect url: {2}", cRemoteHost, cRemoteIP, cRedirectURL);
      ...
      cListenerThread = new Thread(new ParameterizedThreadStart(HandleHTTPClient));
     ...
     * 
     */
    private static void HandleHTTPClient(Object obj)
    {
    ...
    private static void ProcessClient(Object pObj)
    {
      ...
      try
      {
        DoHttpProcessing(lClientMAC, lClientIP, lClientPort, lTCPClient);
      }
      catch (Exception lEx)
      {
